...
<body>
                ...
                <div class="col-lg-8">
                    ...
                    <div id="myGroup">
                        ...
                        <div class="collapse" id="Income-collapse" data-bs-parent="#myGroup">
                            <form name="income-form" id="income-form" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button name="Publish-button" class="Budget-Buttons-publish"
                                            data-bs-toggle="collapse" data-parent="#myGroup"
                                            data-bs-target="#Income-collapse" aria-exanded="false"
                        ...
                        <div class="collapse" id="Expence-collapse" data-bs-parent="#myGroup">
                            ...
                            <form name="expence-form" id="income-form" method="POST">
                                <h2>EXPENSE</h2>
                                ...
                                <div class="row">
                                    ...
                                    <h3>Select the Mode of Expence:</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button name="Publish-button" class="Budget-Buttons-publish"
                                            ...
                                            aria-controls="Expence-collapse" id="Add_Expence" value="Add Expense">
                    ...
                    <div class="Core-Dist">
                        ...
                        <div class="row core-first-row common-box-border">
                            <div class="col-lg-6 col-md-12 inc-exp-ratio">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h3><i class="fa-solid fa-circle fa-2xs inc-ratio-circle"></i> Income: <h2
                                                id="income_perc">0%</h2>
                                        </h3>
                                    </div>

                                    <div class="col-6">
                                        <h3><i class="fa-solid fa-circle fa-2xs exp-ratio-circle"></i> Expense: <h2
                                                id="expense_perc">0%</h2>
                                        </h3>
                                    </div>
                                </div>
                            ...
                            <div class="Expense-main common-box-border">
                                ...
                                <div class="row core-row-third">
                                    ...
                                    <div class="col core-graph">
                                        ...
                                        <div class="row core-graph-row">
                                            ...
                                            <div class="col-md-1 progress-clr-pink expense-core-bar" id="health-bar">
                                        ...
                                        <div class="row core-graph-row">
                                            ...
                                            <div class="col-md-1 progress-clr-violet expense-core-bar" id="clothes-bar">
                                        ...
                                        <div class="row core-graph-row">
                                            ...
                                            <div class="col-md-1 progress-clr-brown expense-core-bar" id="sports-bar">
                                ...
                                <div class="row core-row-fifth common-box-border">
                                    ...
                                    <div class="row core-row-sixth">
                                        ...
                                        <div class="col-md-2" style="width: 20%">
                                            <h3 class="progress-clr-violet-bg expense-dist-label-border">Clothes</h3>
                                        </div>
                                    ...
                                    <div class="row core-row-sixth">
                                        ...
                                        <div class="col-md-3 ">
                                            <h3 class="progress-clr-hunter-bg expense-dist-label-border">Entertain</h3>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <h3 class="progress-clr-pur-pink-bg expense-dist-label-border">Eating-out
                                            </h3>
                                        </div>
                                        <div class="col-md-3">
                                            <h3 class="progress-clr-saffron-bg expense-dist-label-border">Toiletry</h3>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row core-second-row common-box-border">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <h3><i class="fa-solid progress-clr-violet fa-circle fa-2xs"></i> others: <h2
                                                id="others_perc">0%</h2>
                                        </h3>
                                    </div>
                                </div>
    ...
    class user_balances {
        constructor() {
            ...
            this.total_Income = <?php
                                    include("Calc_bal.php");
                                    echo (calc_inc());
                                    ?>;

            this.total_Expence = <?php
                                        include("Calc_bal.php");
                                        echo (calc_exp());
                                        ?>;
    ...
    class income_class {
        constructor(class_title = none) {
                ...
                this.amt = <?php
                            ...
                            $q1 = "SELECT amount FROM $table_name WHERE mode = '<script>document.writeln(class_title);
    </script>'";
